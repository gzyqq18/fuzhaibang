...
**💡 新手提示**：如果你对 "pnpm install"、"依赖" 等概念不熟悉，请先查看 **WHAT_IS_NPM.md** - 用生活中的比喻详细解释
...
**编译过程说明**：
- `pnpm install`：下载并安装项目所需的所有工具包（依赖）
- `pnpm build:ttapp`：将源代码编译成抖音小程序可以运行的格式
- 编译成功后，`dist` 目录会包含所有必要的文件
